...
<div class="container mt-4">
    <h1 class="mb-3">Syarat dan Ketentuan Penggunaan RMS POS</h1>
    <p class="text-muted">Terakhir diperbarui: {{ \Carbon\Carbon::now()->translatedFormat('d F Y') }}</p>

    <hr class="my-4">

    <p>Selamat datang di RMS POS! Dengan mengakses atau menggunakan aplikasi dan layanan RMS POS, Anda secara tegas
        ...
        mengikat antara Anda (pengguna) dan RMS POS.</p>
    ...
    <p>Aplikasi RMS POS dirancang dan dimaksudkan secara eksklusif untuk <strong>keperluan bisnis yang sah</strong>
    ...
    <ul>
        <li><strong>Aktivitas Terlarang:</strong> Penggunaan aplikasi untuk aktivitas ilegal, penipuan, pencemaran nama
            ...
            tidak sah ke sistem RMS POS juga akan dianggap sebagai pelanggaran serius.
        </li>
    ...
    <p>Seluruh konten, fitur, fungsionalitas, desain, kode sumber, logo, merek dagang, dan semua materi lain yang
        terkandung atau terkait dengan aplikasi RMS POS adalah <strong>milik eksklusif RMS POS</strong> atau pemberi
    ...
    <ul>
        <li><strong>Pembatasan:</strong> Anda tidak diperkenankan untuk menyalin, mereproduksi, mendistribusikan,
            ...
            persetujuan tertulis sebelumnya dari RMS POS.</li>
        <li><strong>Lisensi Terbatas:</strong> RMS POS memberikan Anda lisensi terbatas, non-eksklusif, tidak dapat
    ...
    <p>Meskipun RMS POS berusaha keras untuk menyediakan layanan yang stabil dan aman, kami tidak dapat menjamin bahwa
        layanan akan selalu bebas dari kesalahan atau gangguan. Dalam batas maksimum yang diizinkan oleh hukum yang
        berlaku, RMS POS <strong>tidak bertanggung jawab atas kerugian atau kerusakan apa pun</strong> yang timbul dari
    ...
    <ul>
        ...
        <li><strong>Kesalahan Sistem Eksternal:</strong> Kegagalan atau masalah yang timbul dari sistem eksternal,
            jaringan, atau layanan pihak ketiga yang tidak dikelola secara langsung oleh RMS POS.</li>
    ...
    <p>Dalam keadaan apa pun, tanggung jawab total RMS POS kepada Anda atas semua klaim yang timbul dari atau terkait
        dengan penggunaan layanan ini tidak akan melebihi jumlah yang Anda bayarkan kepada RMS POS untuk penggunaan
    ...
    <p>Anda disarankan untuk <strong>memeriksa halaman ini secara berkala</strong> untuk mengetahui setiap perubahan.
        Dengan melanjutkan penggunaan layanan RMS POS setelah perubahan tersebut dipublikasikan, Anda menyatakan
        bahwa Anda telah membaca, memahami, dan <strong>menyetujui seluruh ketentuan yang diperbarui</strong>.
    </p>

    <hr class="my-4">

    <p>Dengan melanjutkan penggunaan RMS POS, Anda secara tegas menyatakan bahwa Anda telah membaca, memahami, dan
