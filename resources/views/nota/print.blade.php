...
<body onload="window.print();">
    ...
    <div>Alamat: Bengkong Sadai, Kec. Bengkong, Kota Batam, Kepulauan Riau</div>
    <hr>
    ...
    <div class="center small bottom-padding">Terima Kasih :)</div>
    <div class="center small bottom-padding">{{ $randomMessage }}</div>
</body>
