                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <div class="profile-img position-relative">
                            <img src="{{ $supplier->photo ? asset('storage/suppliers/' . $supplier->photo) : asset('assets/images/user/1.png') }}"
                    ...
                    <ul class="list-inline p-0 mb-0">
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $supplier->name }}"
                                        readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $supplier->email }}"
                                        readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $supplier->phone }}"
                                        readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $supplier->shopname }}"
                                        readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $supplier->type }}"
                                        readonly>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white"
                                        value="{{ $supplier->account_holder }}" readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $supplier->bank_name }}"
                                        readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white"
                                        value="{{ $supplier->account_number }}" readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white"
                                        value="{{ $supplier->bank_branch }}" readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $supplier->city }}"
                                        readonly>
                                </div>
                            </div>
                        </li>
