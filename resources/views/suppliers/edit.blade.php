                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('shopname') is-invalid @enderror"
                                    id="shopname" name="shopname" value="{{ old('shopname', $supplier->shopname) }}"
                                    required>
                                @error('shopname')
                                <div class="invalid-feedback">
                                    {{ $message }}
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control @error('bank_name') is-invalid @enderror" name="bank_name">
                                    ...
                                    <option value="BRI" @if(old('bank_name', $supplier->bank_name) ==
                                        'BRI')selected="selected"@endif>BRI</option>
                                    <option value="BNI" @if(old('bank_name', $supplier->bank_name) ==
                                        'BNI')selected="selected"@endif>BNI</option>
                                    <option value="BCA" @if(old('bank_name', $supplier->bank_name) ==
                                        'BCA')selected="selected"@endif>BCA</option>
                                    <option value="BSI" @if(old('bank_name', $supplier->bank_name) ==
                                        'BSI')selected="selected"@endif>BSI</option>
                                    <option value="Mandiri" @if(old('bank_name', $supplier->bank_name) ==
                                        'Mandiri')selected="selected"@endif>Mandiri</option>
                                </select>
                                @error('bank_name')
                                <div class="invalid-feedback">
                                    {{ $message }}
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('city') is-invalid @enderror" id="city"
                                    name="city" value="{{ old('city', $supplier->city) }}" required>
                                @error('city')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control @error('type') is-invalid @enderror" name="type" required>
                                    ...
                                    <option value="Distributor" @if(old('type', $supplier->type) ==
                                        'Distributor')selected="selected"@endif>Distributor</option>
                                    <option value="Whole Seller" @if(old('type', $supplier->type) == 'Whole
                                        Seller')selected="selected"@endif>Whole Seller</option>
                                </select>
                                @error('type')
                                <div class="invalid-feedback">
                                    {{ $message }}
