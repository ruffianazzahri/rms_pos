        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">A supplier dashboard lets you easily gather and visualize supplier data from
                        optimizing <br>
                        the supplier experience, ensuring supplier retention. </p>
                </div>
                <div>
                    <a href="{{ route('suppliers.create') }}" class="btn btn-primary add-list"><i
                            class="fa-solid fa-plus mr-3"></i>Add Supplier</a>
                            ...
                            <td>
                                <div class="d-flex align-items-center list-action">
                                    ...
                                    <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title=""
                                        ...
                                        href="{{ route('suppliers.edit', $supplier->id) }}""><i class=" ri-pencil-line
                                        mr-0"></i>
                                    </a>
