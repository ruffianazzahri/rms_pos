...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-12 mb-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="min-width: 140px;">
                            <form action="{{ route('pos.kafe.updateCart', $item->rowId) }}" method="POST">
                                @csrf
                                <div class="input-group">
                                    <input type="number" class="form-control" name="qty" required
                                        value="{{ old('qty', $item->qty) }}">
                                    <div class="input-group-append">
                                        <button type="submit" class="btn btn-success border-none" data-toggle="tooltip"
                                            data-placement="top" title="" data-original-title="Sumbit"><i
                        ...
                        <td>{{ $item->subtotal }}</td>
                        <td>
                            <a href="{{ route('pos.kafe.deleteCart', $item->rowId) }}"
            ...
            <form action="{{ route('pos.kafe.createInvoice') }}" method="POST">
                @csrf
                <div class="row mt-3">
                    <div class="col-md-12">
                        <div class="input-group">
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody class="ligth-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('pos.kafe.addCart') }}" method="POST">
                                            @csrf
                                            ...
                                            <button type="submit" class="btn btn-primary border-none"
                                                ...
                                                data-original-title="Add"><i class="far fa-plus mr-0"></i></button>
                                        </form>
                                    </td>
                                </tr>
