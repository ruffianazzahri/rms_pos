                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('shopname') is-invalid @enderror"
                                    id="shopname" name="shopname" value="{{ old('shopname', $customer->shopname) }}"
                                    required>
                                @error('shopname')
                                <div class="invalid-feedback">
                                    {{ $message }}
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control @error('bank_name') is-invalid @enderror" name="bank_name">
                                    ...
                                    <option value="BRI" @if(old('bank_name', $customer->bank_name) ==
                                        'BRI')selected="selected"@endif>BRI</option>
                                    <option value="BNI" @if(old('bank_name', $customer->bank_name) ==
                                        'BNI')selected="selected"@endif>BNI</option>
                                    <option value="BCA" @if(old('bank_name', $customer->bank_name) ==
                                        'BCA')selected="selected"@endif>BCA</option>
                                    <option value="BSI" @if(old('bank_name', $customer->bank_name) ==
                                        'BSI')selected="selected"@endif>BSI</option>
                                    <option value="Mandiri" @if(old('bank_name', $customer->bank_name) ==
