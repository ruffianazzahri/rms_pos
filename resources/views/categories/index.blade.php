        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">A Category dashboard lets you easily gather and visualize Category data from
                        optimizing <br>
                        the Category experience, ensuring Category retention. </p>
                </div>
                <div>
                    <a href="{{ route('categories.create') }}" class="btn btn-primary add-list"><i
                            class="fas fa-plus mr-3"></i>Create Category</a>
                            ...
                            <td>
                                <div class="d-flex align-items-center list-action">
                                    <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title=""
                                        ...
                                        href="{{ route('categories.edit', $category->slug) }}""><i class="
