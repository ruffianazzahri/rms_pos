        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">A permission dashboard lets you easily gather and visualize permission data from
                        optimizing <br>
                        the permission experience, ensuring permission retention. </p>
                </div>
                <div>
                    <a href="{{ route('permission.create') }}" class="btn btn-primary add-list"><i
                            class="fa-solid fa-plus mr-3"></i>Add Permission</a>
                </div>
            </div>
        </div>
                                ...
                                <form action="{{ route('permission.destroy', $permission->id) }}" method="POST"
                                    ...
                                    <div class="d-flex align-items-center list-action">
                                        <a class="btn btn-success mr-2" data-toggle="tooltip" data-placement="top"
                                            ...
                                            href="{{ route('permission.edit', $permission->id) }}""><i class="
